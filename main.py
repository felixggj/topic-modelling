...
if __name__ == '__main__':
    ...
    documents = [
        ...
        "Although electric vehicles (EVs) are climate-friendly alternaRve to gasoline powered vehicles, adopRon is challenged, in large measure, by higher up-front procurement prices. ExisRng discourse emphasizes EV ba^ery costs as being principally responsible for this price differenRal and EV affordability – and consequently, widespread adopRon - is rouRnely condiRoned upon ba^ery costs declining" 
    ]
